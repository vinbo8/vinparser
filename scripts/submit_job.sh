...
--train $root/thesis/data/en-hi/en-hi-train-scrambled.25.conllu \
...
qsub -e "$root/thesis/results/err_$1" -o "$root/thesis/results/$1" -N "$1" -q gpu-ms.q@dll[336] -l gpu=1,gpu_cc_min3.5=1,gpu_ram=4G -p 0 parse.sh
