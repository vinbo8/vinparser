...
if __name__ == '__main__':
    ...
    if args.cl_tagger:
        ...
        if args.parse:
            if args.code_switch:
                runnable = CSParser(sizes, args, embeddings=None, embed_dim=EMBED_DIM, lstm_dim=10, lstm_layers=1,
                                reduce_dim_arc=10, reduce_dim_label=REDUCE_DIM_LABEL, learning_rate=LEARNING_RATE)
            else:
